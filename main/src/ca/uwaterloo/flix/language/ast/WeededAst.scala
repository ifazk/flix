...
object WeededAst {
  ...
  object Declaration {
    ...
    case class TypeAlias(doc: Ast.Doc, mod: Ast.Modifiers, ident: Name.Ident, tparams: List[Name.Ident], tpe: WeededAst.Type, loc: SourceLocation) extends WeededAst.Declaration
